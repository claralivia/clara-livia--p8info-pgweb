...
<body>
    ...
    <?php
            ...
            $sql = "INSERT INTO atelie_bolos (nomeCliente, emailCliente, telefoneCliente, tipoBolo, modificacoes) VALUES (?,?,?,?,?)";

            $stmt = mysqli_stmt_init($conn);
            $stmt_prepared_okay = mysqli_stmt_prepare($stmt,$sql);

            if($stmt_prepared_okay){
                mysqli_stmt_bind_param($stmt, "sssss", $nomeCliente, $emailCliente, $telefoneCliente, $tipoBolo, $modificacoes);
